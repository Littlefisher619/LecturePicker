...
public class Mail
{
    private String qqEmail,qqAuthorizeCode,receiver;
    private Properties props=new Properties();
    private Authenticator authenticator;
    public Mail(String qqEmail, String qqAuthorizeCode) {
        this.qqEmail = qqEmail;
        this.qqAuthorizeCode = qqAuthorizeCode;
        this.receiver=qqEmail;
        init();
    }
    private void init(){
        /*
        ...
        // 发件人的账号
        props.put("mail.user", qqEmail);
        // 访问SMTP服务时需要提供的密码
        props.put("mail.password", qqAuthorizeCode);
